...
## 🏨 מלון רוקסון רד סי אילת (הלקוח הראשון — אין תאריך דמו סופי עדיין)
...
| מטרה | נתיב |
|---|---|
| **צ׳ק ליסט סופר אדמין (Dashboard)** | [`docs/super-admin-dashboard-qa.md`](docs/super-admin-dashboard-qa.md) |
