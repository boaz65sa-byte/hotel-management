...
abstract class AppLocalizations {
  ...
  /// No description provided for @claimTicket.
  ///
  /// In en, this message translates to:
  /// **'Claim Ticket'**
  String get claimTicket;

  /// No description provided for @claimRequiresConnection.
  ///
  /// In en, this message translates to:
  /// **'Claiming requires internet connection'**
  String get claimRequiresConnection;

  /// No description provided for @ticketFixed.
  ///
  /// In en, this message translates to:
  /// **'Fixed'**
  String get ticketFixed;

  /// No description provided for @ticketOnHold.
  ///
  /// In en, this message translates to:
  /// **'On Hold'**
  String get ticketOnHold;

  /// No description provided for @ticketRoomClosed.
  ///
  /// In en, this message translates to:
  /// **'Room Closed'**
  String get ticketRoomClosed;
