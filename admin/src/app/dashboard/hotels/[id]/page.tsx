  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        {viewer.isSuperAdmin && (
          <a
            href={`/dashboard/hotels/${hotel.id}/request-tiles`}
            className="inline-flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-700"
          >
            🧩 כרטיסיות בקשה
          </a>
        ...
        {viewer.isSuperAdmin && (
          <a
            href={`/dashboard/hotels/${hotel.id}/departments`}
            className="inline-flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-700"
          >
            🏢 מחלקות צוות
          </a>
        ...
        {viewer.isSuperAdmin && (
          <a
            href={`/dashboard/hotels/${hotel.id}/request-categories`}
            className="inline-flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-700"
          >
            🧾 קטגוריות בקשה
          </a>
        ...
        {viewer.isSuperAdmin && (
          <a
            href={`/dashboard/hotels/${hotel.id}/custom-departments`}
            className="inline-flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-700"
          >
            🏷️ מחלקות מותאמות
          </a>
