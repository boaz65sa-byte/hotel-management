// lib/features/home/presentation/kitchen_home.dart
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:go_router/go_router.dart';
import 'package:hotel_app/core/i18n/app_localizations.dart';
import 'package:hotel_app/features/home/providers/kitchen_home_provider.dart';
...
class KitchenHomeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<KitchenHomeScreen> createState() =>
      _KitchenHomeScreenState();
}
...
class _KitchenHomeScreenState extends ConsumerState<KitchenHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabs = [
      (icon: Icons.queue,        label: 'קריאות',  screen: const _KitchenQueue()),
...
class _KitchenQueue extends ConsumerStatefulWidget {
  const _KitchenQueue();

  @override
  ConsumerState<_KitchenQueue> createState() => _KitchenQueueState();
}

class _KitchenQueueState extends ConsumerState<_KitchenQueue> {
  String _filter = 'הכל';
      ...
      body: Column(
        children: [
          ...
          ticketsAsync.maybeWhen(
            data: (tickets) => _KitchenHeader(tickets: tickets),
              orElse: () => const _KitchenHeader(tickets: []),
          ),
...
class _KitchenHeader extends StatelessWidget {
  ...
  const _KitchenHeader({required this.tickets});
